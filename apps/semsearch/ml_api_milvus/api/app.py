...
def load_corpus(config_object: Config):
    #connections.connect("default", host="34.168.23.74", port="19530")
    connections.connect("default", host=config_object.MILVUS_HOST, port=config_object.MILVUS_PORT)
...
def create_app(*, config_object: Config) -> connexion.App:
    ...
    fsdl_ip = load_corpus(config_object=config_object)
